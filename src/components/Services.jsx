...
const Services = () => {
  ...
  const translations = {
    id: {
      heroTitle: "Solusi Digital",
      heroTitleGradient: "Tanpa Kompromi",
      heroSubtitle: "Kami menggabungkan estetika premium dengan teknologi mutakhir untuk menciptakan website yang bukan sekadar ada, tapi menghasilkan.",
      workTitle: "Alur Kerja",
      workTitleGradient: "Profesional",
      workSubtitle: "Bagaimana kami mewujudkan visi Anda menjadi realitas digital.",
      standardTitle: "Standar",
      standardTitleGradient: "Aurotech",
  ...
  // Map icons back to translated data
  const icons = [<FiLayout />, <FiLayers />, <FiDatabase />];
  const coreSolutions = t.coreSolutions.map((sol, index) => ({
    ...sol,
    icon: icons[index]
  }));

  const benefitIcons = [<FiZap />, <FiSmartphone />, <FiShield />];
  ...
  return (
    <div className="services-page-container">
      ...
      <section className="section services-top-section">
        <div className="container">
          <div className="section-header text-center mb-16">
            <h1 className="section-title h1 animate-entrance">{t.heroTitle} <br /> <span className="text-gradient">{t.heroTitleGradient}</span></h1>
      ...
      <section className="section process-section bg-secondary">
        <div className="container">
          <div className="section-header text-center">
            <h2 className="section-title">{t.workTitle} <span className="text-gradient">{t.workTitleGradient}</span></h2>
      ...
      <section className="section benefits-section">
        <div className="container">
          <div className="section-header text-center">
            <h2 className="section-title">{t.standardTitle} <span className="text-gradient">{t.standardTitleGradient}</span></h2>
