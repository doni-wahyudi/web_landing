...
export const projects = [
  {
    ...
    challenge: {
      ...
      en: "The client needs a professional company profile to reach a credible national and international B2B market."
    },
    solution: {
      ...
      en: "We designed a professional website with a layout showcasing factory capacity, export-standard product catalogs, and an integrated quotation form (Call-to-Action)."
    },
  ...
  },
  {
    ...
    solution: {
      ...
      en: "A website with a dark, elegant, and informative aesthetic design showcasing services, pricing, and easy booking/contact integration."
    },
  ...
  },
  {
    ...
    challenge: {
      ...
      en: "A tutoring institution needing a high-conversion landing page for its new student enrollment program."
    },
    solution: {
      id: "Desain UI modern yang menonjolkan fitur unggulan, testimoni, dan bagian CTA yang kuat untuk pendaftaran kelas langsung.",
      en: "Modern UI design highlighting key features, testimonials, and a strong CTA section for direct class registration."
    },
  ...
  },
  {
    ...
    solution: {
      ...
      en: "We built a health portal with an integrated online reservation system, complete doctor profiles, and WhatsApp integration for instant patient support."
    },
  ...
  },
  {
    ...
    challenge: {
      ...
      en: "A fragmented car rental market often makes it hard for customers to find trusted services with transparent pricing and well-maintained vehicles."
    },
    solution: {
      ...
      en: "A high-conversion landing page with an elegant fleet catalog, one-click WhatsApp booking, and professional service details for daily or special event needs."
    },
  ...
  },
  {
    ...
    challenge: {
      ...
      en: "A local bakery with aesthetic products often struggles to showcase their visuals digitally, missing out on online order potential."
    },
    solution: {
      ...
      en: "A web design prioritizing product visuals (appetizing design) with organized menu catalogs and direct ordering CTAs for easy customer conversion."
    },
