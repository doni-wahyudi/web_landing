...
const trackerTranslations = {
  id: {
    ...
    sumOutreachCount: 'Kontak Baru *',
    sumColdFuCount: 'Cold Follow-up *',
    sumWarmFuCount: 'Warm Follow-up *',
    sumResponseCount: 'Respons Diterima *',
    sumDealsCount: 'Deals Closed *',
    sumFailedCount: 'Gagal / Menolak *',
  ...
  en: {
    ...
    sumOutreachCount: 'New Outreach Contacts *',
    sumColdFuCount: 'Cold Follow-ups *',
    sumWarmFuCount: 'Warm Follow-ups *',
    sumResponseCount: 'Responses Received *',
    sumDealsCount: 'Deals Closed *',
    sumFailedCount: 'Failed / Rejected *',
